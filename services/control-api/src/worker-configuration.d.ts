/* eslint-disable */
// Generated by Wrangler by running `wrangler types services/control-api/src/worker-configuration.d.ts` (hash: 82b3871ce5c970c7137ab0b40af6355d)
// Runtime types generated with workerd@1.20260722.1 2026-07-27 nodejs_compat
interface __BaseEnv_Env {
  SNAPSHOTS: R2Bucket;
  PUSH_QUEUE: Queue;
  ASSETS: Fetcher;
  RELAY_AUTH_DISABLED: "true" | "false";
  RELAY_JWT_ISSUER:
    | "https://local.pocket-omp.invalid"
    | "https://pocket-omp-review.takumi3488.workers.dev"
    | "https://pocket-omp.takumi3488.workers.dev";
  RELAY_JWKS_URL:
    | "https://local.pocket-omp.invalid/.well-known/jwks.json"
    | "https://pocket-omp-review.takumi3488.workers.dev/.well-known/jwks.json"
    | "https://pocket-omp.takumi3488.workers.dev/.well-known/jwks.json";
  ADMIN_AUTH_DISABLED: "true" | "false";
  STAFF_SSO_ISSUER: "https://local.pocket-omp.invalid" | "https://staff.pocket-omp.invalid";
  STAFF_SSO_AUDIENCE: "pocket-omp-admin";
  STAFF_SSO_JWKS_URL:
    | "https://local.pocket-omp.invalid/.well-known/jwks.json"
    | "https://staff.pocket-omp.invalid/.well-known/jwks.json";
  CONTROL_AUTH_DISABLED: "true" | "false";
  OIDC_ISSUER: "https://local.pocket-omp.invalid" | "https://prod-i4hujf.jp.auth0.com/";
  OIDC_JWKS_URL:
    | "https://local.pocket-omp.invalid/.well-known/jwks.json"
    | "https://prod-i4hujf.jp.auth0.com/.well-known/jwks.json";
  OIDC_AUDIENCE: "pocket-omp-api";
  ENTITLEMENT_AUTO_GRANT: "true";
  SERVICE_IDENTIFIER: "pocket-omp";
  REVIEW_HOST_ENABLED: "true" | "false";
  DEPLOYMENT_PURPOSE: "app-review" | "production";
  RELAY_MAILBOX: DurableObjectNamespace<import("./index").RelayMailbox>;
  REVIEW_SESSION: DurableObjectNamespace<import("./index").ReviewSession>;
  ADMIN_CONTROL: DurableObjectNamespace<import("./index").AdminControl>;
  RELAY_ORIGIN?:
    | "https://pocket-omp-review.takumi3488.workers.dev"
    | "https://pocket-omp.takumi3488.workers.dev";
}
declare namespace Cloudflare {
  interface GlobalProps {
    ...
    durableNamespaces: "RelayMailbox" | "ReviewSession" | "AdminControl";
  }
  interface LocalEnv {
    SNAPSHOTS: R2Bucket;
    PUSH_QUEUE: Queue;
    ...
    OIDC_ISSUER: "https://local.pocket-omp.invalid";
    OIDC_JWKS_URL: "https://local.pocket-omp.invalid/.well-known/jwks.json";
    OIDC_AUDIENCE: "pocket-omp-api";
    ENTITLEMENT_AUTO_GRANT: "true";
    SERVICE_IDENTIFIER: "pocket-omp";
  ...
  interface ReviewEnv {
    ...
    RELAY_JWT_ISSUER: "https://pocket-omp-review.takumi3488.workers.dev";
    RELAY_JWKS_URL: "https://pocket-omp-review.takumi3488.workers.dev/.well-known/jwks.json";
    RELAY_ORIGIN: "https://pocket-omp-review.takumi3488.workers.dev";
    ...
    CONTROL_AUTH_DISABLED: "true";
    OIDC_ISSUER: "https://prod-i4hujf.jp.auth0.com/";
    OIDC_JWKS_URL: "https://prod-i4hujf.jp.auth0.com/.well-known/jwks.json";
    OIDC_AUDIENCE: "pocket-omp-api";
    ENTITLEMENT_AUTO_GRANT: "true";
    SERVICE_IDENTIFIER: "pocket-omp";
    REVIEW_HOST_ENABLED: "true";
